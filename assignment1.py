...
class RS_perceptron:
  # Constructor
    def __init__(self, nmax, learning_rate):
        self.nmax = nmax
...
def run_simulation(P = None, N = 2, alpha = 0.75, nmax = 100):
	if P is None: 
		P = int(N * alpha)
...
N_values = [2]
P_values = [None]
alpha_values = [0.75, 1, 1.25, 1.5, 1.75,2,2.25,2.5,2.75,3]
nmax_values = [100]
		...
		for alpha in alpha_values:
			for nmax in nmax_values:
				for ND in ND_values:
					successfull_runs = 0
					for i in range(0, ND):
						succes = run_simulation(P, N, alpha, nmax)
						if succes: 
							successfull_runs += 1
					print("N: {}, P: {}, alpha: {}, nmax: {}, ND: {}, Succesfull runs: {}".format(N, P, alpha, nmax, ND, successfull_runs))
